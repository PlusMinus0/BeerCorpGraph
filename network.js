...
var nodes = new vis.DataSet([
    ...
    {id: 'Allgäuer Brauhaus',                              label: 'Allgäuer Brauhaus',                              value: 23.6e6, group: 'Radeberger Gruppe KG'},
...
var edges = new vis.DataSet([
    {from: 'Allgäuer', to: 'Allgäuer Brauhaus'},
    {from: 'Altenmünster', to: 'Allgäuer Brauhaus'},
    {from: 'Büble', to: 'Allgäuer Brauhaus'},
    {from: 'Fürstabt', to: 'Allgäuer Brauhaus'},
    {from: 'Norbertus', to: 'Allgäuer Brauhaus'},
    {from: 'Oberdorfer', to: 'Allgäuer Brauhaus'},
    {from: 'Teutsch', to: 'Allgäuer Brauhaus'},
    ...
    {from: 'Allgäuer Brauhaus', to: 'Radeberger Gruppe KG'},
